...
# Links:
* [Package fars GitHub](https://github.com/ZYDI/FARS)
* [Package fars Travis CI](https://travis-ci.org/ZYDI/FARS)
* [Package Appveyor](https://ci.appveyor.com/project/ZYDI/FARS)
